...
class ZaloEndPoint {
     ...
     * @const 
     */
    const API_GRAPH_FRIENDS = 'https://graph.zaloapp.com/v2.0/me/friends';

    /**
     * @const 
     */
    const API_GRAPH_INVITABLE_FRIENDS = 'https://graph.zaloapp.com/v2.0/me/invitable_friends';

    /**
     * @const 
     */
    const API_GRAPH_POST_FEED = 'https://graph.zaloapp.com/v2.0/me/feed';

    /**
     * @const 
     */
    const API_GRAPH_APP_REQUESTS = 'https://graph.zaloapp.com/v2.0/apprequests';

    /**
     * @const 
     */
    const API_GRAPH_MESSAGE = 'https://graph.zaloapp.com/v2.0/me/message';
